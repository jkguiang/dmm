...
class MonitoringSession(object):
    def __init__(self) -> None:
        self.prometheus_host = env.get("PROMETHEUS_HOST")
        self.prometheus_port = env.get("PROMETHEUS_PORT") or 9090
        self.prometheus_addr = f"http://{self.prometheus_host}:{self.prometheus_port}"
